      ...
      <section className="login-wrapper">
        <div className="login-card">
          ...
          <div className="login-title">
            <p>WELCOME BACK</p>
            <h1>Welcome Back</h1>
            <span>Login to your SmartAgri account.</span>
          </div>
          ...
          <div className="login-role-section">
            ...
            <div className="login-role-buttons">
              <button
                ...
                className={role === "customer" ? "login-role-button active" : "login-role-button"}
              >
                👤 Customer
              </button>
              <button
                ...
                className={role === "farmer" ? "login-role-button active" : "login-role-button"}
              >
                👨‍🌾 Farmer
              </button>
            </div>
